...
typedef enum 
{
	...
	kADMDummyAction				= kADM8F32	// cpaduan 11/14/00: CWPro6
}
ADMAction;
...
typedef enum 
{
	...
	kADMDummyModifier			= kADMAllFs32	// cpaduan 11/14/00: CWPro6
}
ADMModifiers;
...
typedef struct ADMTrackerSuite1
{
	...
	void ASAPI (*GetPoint)(ADMTrackerRef inTracker, ASPoint* outPoint);
	
	ADMAction ASAPI (*GetAction)(ADMTrackerRef inTracker);
	ADMModifiers ASAPI (*GetModifiers)(ADMTrackerRef inTracker);
	
	ASBoolean ASAPI (*TestAction)(ADMTrackerRef inTracker, ADMAction inAction);
	ASBoolean ASAPI (*TestModifier)(ADMTrackerRef inTracker, ADMModifiers inModifier);
