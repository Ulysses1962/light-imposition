...
/* for Adobe use only */
#define _ASCallsHFT_LATEST_VERSION 0x00070000
#define _ASCallsHFT_LAST_BETA_COMPATIBLE_VERSION 0x00070000
...
#define ASCallsHFT_VERSION_7   ASCallsHFT_LATEST_VERSION
...
#undef NPROC
   ...
   /* These calls have a different name internally */
	#define ASGetSecs	ASSecs

#if !ACROBAT_LIBRARY
   #define ASFixedMul ASHFTClientFixedMul
   #define ASFixedDiv ASHFTClientFixedDiv
   #define ASFixedToCString ASHFTClientToCString
   #define ASCStringToFixed ASHFTClientFixedToCString
#endif
...
#define ASSERT_AS_VER(X) (ACROASSERT(gAcroSupportHFT),ACROASSERT(gAcroSupportVersion>=X))
