...
/* for Adobe use only */
#define _ASExtraHFT_LATEST_VERSION 0x00070000
#define _ASExtraHFT_LAST_BETA_COMPATIBLE_VERSION 0x00070000
#define _ASEXTRA_IS_BETA 0

/* for public use */
#define ASExtraHFT_LATEST_VERSION (_ASEXTRA_IS_BETA ? (kHFT_IN_BETA_FLAG | _ASExtraHFT_LATEST_VERSION) : _ASExtraHFT_LATEST_VERSION)

#define ASExtraHFT_VERSION_5 0x00050000
#define ASExtraHFT_VERSION_6 0x00060000
#define ASExtraHFT_VERSION_7 ASExtraHFT_LATEST_VERSION
...
#ifdef __cplusplus
	template <class T>
	inline T ASCabGetPointerTypeSafe(ASCab theCab, const char *keyName, char *expectedType)
	{
#ifndef __GNUG__
