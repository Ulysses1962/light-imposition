...
/* for Adobe use only */
#define _AcroViewHFT_LATEST_VERSION 0x00070000
#define _AcroViewHFT_LAST_BETA_COMPATIBLE_VERSION 0x00070000
...
#define AcroViewHFT_VERSION_7   AcroViewHFT_LATEST_VERSION
...
/* These have different names due to internal change over to use UCS word list for Text selection */
	#define	AVDocGetPageText AVDocGetPageTextHost
   ...
   #undef UNPROC
   #undef USPROC
   #undef AVAppRegisterNotification 
   #undef AVAppUnregisterNotification 
...
#define AVRegisterAuxDataHandler AVROUTINE(AcroViewHFT_VERSION_2_2, AVRegisterAuxDataHandler)
...
#define AVPageViewInvertQuad AVROUTINE(AcroViewHFT_VERSION_4, AVPageViewInvertQuad)
