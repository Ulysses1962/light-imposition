/*********************************************************************************
 ...
 ---------------------------------------------------------------------
	...
	- This file contains code that makes sure ASRaiseAware objects are
...
{
	IsRaiseAwareClass< T >::Raise_Aware_Classes_Must_Use_The_Macro_RAISEAWARECLASS tester = 0;
}

template < class T >
inline void IsNotRaiseAwareClassHelperFunction( T someInstance )
{
	IsRaiseAwareClass< T >::You_Can_Not_E_Return_Raise_Aware_Objects tester = 0;
}
