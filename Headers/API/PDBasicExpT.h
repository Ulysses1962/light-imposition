...
/** The underlying PDF representation of a document. There is a correspondence
	...
	Through PDDocs, your application can perform most of the Edit -> Pages menu items
	...
	object as well. The first page in a PDDoc is page 0.
	@see AVDocGetPDDoc
	@see PDDocFromCosDoc
	@see PDDocOpen
...
/** A single page in the PDF representation of a document. Just as PDF files are partially
	composed of their pages, PDDocs are composed of PDPages. A page contains a
...
/** A font that is used to draw text on a page. It corresponds to a Font Resource in a PDF
	file. Applications can get a list of PDFonts used on a PDPage or a range of PDPages.
...
/** pointer to a PDTextSelect struct. */
...
end word, where "start" is the first of a series of selected words and "end" is the first
