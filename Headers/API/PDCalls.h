...
/* for Adobe use only */
#define _PDModelHFT_LATEST_VERSION 0x00070000
#define _PDModelHFT_LAST_BETA_COMPATIBLE_VERSION 0x00070000
...
#define PDModelHFT_VERSION_7   _PDModelHFT_LATEST_VERSION
...
#include "PDExpT.h"
   ...
   #define PDXlateToHostEx PDXlateToExtHost
   #define PDXlateToPDFDocEncEx PDXlateToExtPDFDocEnc

	/* These has different name due to internal change over to use UCS word list for Text selection */
	...
	#define PDTextSelectCreatePageHiliteEx PDTextSelectCreatePageHiliteEx
	#define	PDTextSelectCreateWordHiliteEx PDTextSelectCreateWordHiliteEx
	#define PDTextSelectCreateRangesEx PDTextSelectCreateRangesEx
