...
/* for Adobe use only */
#define _PDSWrite_LATEST_VERSION 0x00070000
#define _PDSWrite_LAST_BETA_COMPATIBLE_VERSION 0x00070000
...
#define PDSWrite_VERSION_7   PDSWriteHFT_LATEST_VERSION 
