...
#define USE_NULLDOC 1

/* The following are required for Filter */
#define ENVIRONMENT "PS2Prefix.h"
#define ACROBAT 1
...
** path specification. POSIX standard is 255 as defined in limits.h.
*/
#include <limits.h>
#define _MAX_PATH _POSIX_PATH_MAX /* unix_newport_changes:sdash: this has to be this way here and not in miUtils. No magic 255 pls */
