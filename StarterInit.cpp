...
*/
static ACCB1 void ACCB2 LICommand (void *data);
static ACCB1 ASBool ACCB2 LIIsEnabled (void *permRequired);
...
ACCB1 ASBool ACCB2 PluginInit(void)
{
	...
	if (commandMenu)
	{
		menuItem = AVMenuItemNew ("Light Imposition", "Light Imposition", (AVMenu)NULL, false, NO_SHORTCUT, 0, NULL, gExtensionID);
		AVMenuItemSetExecuteProc (menuItem,	ASCallbackCreateProto(AVExecuteProc, &LICommand), NULL);
		AVMenuItemSetComputeEnabledProc (menuItem,ASCallbackCreateProto(AVComputeEnabledProc, &LIIsEnabled), NULL);
...
{
	return ASAtomFromString("ADBE:LightImposition");	/* Change to your extension's name */
}
